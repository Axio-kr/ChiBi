! function (t, e) {
    ...
    return function (t) {
        ...
        _.runtimes = [], _.urlToJSON = h, _.jsonToSettings = d, _.waitUntilReady = c, _.setupOptionals = p, _.setupEssentials = g, _.createInternalModel = m, _.live2DModelMiddlewares = [h, d, c, p, g, m], _.motionTasksMap = new WeakMap, _.expressionTasksMap = new WeakMap, r.g.prototype._loadMotion = function (t, e) {
        ...
        class f extends n.Container {
            ...
            focus(t, e, i = !1) {
                p.x = t, p.y = e, this.toModelPosition(p, p, !0), this.internalModel.focusController.focus(p.x / this.internalModel.originalWidth * 2 - 1, -(p.y / this.internalModel.originalHeight * 2 - 1), i)
            }
            tap(t, e) {
            ...
            hitTest(t, e) {
                return p.x = t, p.y = e, this.toModelPosition(p, p), this.internalModel.hitTest(p.x, p.y)
            }
            ...
            _render(t) {
                ...
                const r = g.copyFrom(t.globalUniforms.uniforms.projectionMatrix).append(this.worldTransform);
        ...
        class b {
            static resolveURL(t, e) {
                var i;
                const r = null === (i = b.filesMap[t]) || void 0 === i ? void 0 : i[e];
            ...
            static createSettings(t) {
                return M(this, void 0, void 0, (function* () {
                    ...
                    const i = yield b.readText(e), r = JSON.parse(i);
        ...
        b.filesMap = {}, b.factory = (t, e) => M(void 0, void 0, void 0, (function* () {
            if (Array.isArray(t.source) && t.source[0] instanceof File) {
                ...
                i.validateFiles(e.map(t => encodeURI(t.webkitRelativePath))), yield b.upload(e, i), i.resolveURL = function (t) {
                    ...
                    t.once("destroy", (function () {
                        ...
                        if (URL.revokeObjectURL(t), b.filesMap[t])
                            for (const e of Object.values(b.filesMap[t])) URL.revokeObjectURL(e);
                        delete b.filesMap[t]
                    }))
                })
            }
        ...
        class S {
            static unzip(t, e) {
                return P(this, void 0, void 0, (function* () {
                    const i = yield S.getFilePaths(t), r = [];
            ...
            static createSettings(t) {
                return P(this, void 0, void 0, (function* () {
                    const e = (yield S.getFilePaths(t)).find(t => t.endsWith("model.json") || t.endsWith("model3.json"));
        ...
        S.ZIP_PROTOCOL = "zip://", S.uid = 0, S.factory = (t, e) => P(void 0, void 0, void 0, (function* () {
            const i = t.source;
            let r, s, n;
            if ("string" == typeof i && (i.endsWith(".zip") || i.startsWith(S.ZIP_PROTOCOL)) ? (r = i.startsWith(S.ZIP_PROTOCOL) ? i.slice(S.ZIP_PROTOCOL.length) : i, s = yield v.a.load({
                    url: r,
                    type: "blob",
                    target: t.live2dModel
                ...
                n || (n = yield S.createSettings(e)), n._objectURL = S.ZIP_PROTOCOL + S.uid + "/" + n.url;
        ...
        t.exports = function (t, e, i, u) {
            ...
            for (t === e && (e = a(e)), i && (p = r(t, o(i))); ++d < c;)
                for (var g = 0, m = e[d], f = i ? i(m) : m;
                    (g = h(p, f, g, u)) > -1;) p !== t && l.call(p, g, 1), l.call(t, g, 1);
            return t
        }
    }, function (t, e, i) {
        var r = i(65),
        ...
        Live2DMotion.prototype.updateParam = function (t, e) {
            r.call(this, t, e), e.isFinished() && this.onFinishHandler && (this.onFinishHandler(this), delete this.onFinishHandler)
        }
    }, function (t, e, i) {
        var r = i(95),
            s = i(23),
        ...
        class q extends b {
            ...
            doUpdateParameters(t, e, i, r) {
                ...
                for (p = 0; p < this._motionData.curveCount && f[p].type == A.CubismMotionCurveTarget_Model; ++p) c = Y(this._motionData, p, m), f[p].id == this._modelCurveIdEyeBlink ? a = c : f[p].id == this._modelCurveIdLipSync && (n = c);
                for (; p < this._motionData.curveCount && f[p].type == A.CubismMotionCurveTarget_Parameter; ++p) {
                    ...
                    if (f[p].fadeInTime < 0 && f[p].fadeOutTime < 0) _ = s + (c - s) * i;
                    else {
                        let t, i;
                        t = f[p].fadeInTime < 0 ? h : 0 == f[p].fadeInTime ? 1 : o.getEasingSine((e - r.getFadeInStartTime()) / f[p].fadeInTime), i = f[p].fadeOutTime < 0 ? d : 0 == f[p].fadeOutTime || r.getEndTime() < 0 ? 1 : o.getEasingSine((r.getEndTime() - e) / f[p].fadeOutTime), _ = s + (c - s) * (this._weight * t * i)
                    }
                ...
                for (; p < this._motionData.curveCount && f[p].type == A.CubismMotionCurveTarget_PartOpacity; ++p) g = t.getParameterIndex(f[p].id), -1 != g && (c = Y(this._motionData, p, m), t.setParameterValueByIndex(g, c));
                    ...
                    for (let r = 0; r < e.getMotionCurveSegmentCount(t);) {
                        switch (0 == r ? (this._motionData.segments[n].basePointIndex = s, this._motionData.points[s] = new R(e.getMotionCurveSegment(t, r), e.getMotionCurveSegment(t, r + 1)), s += 1, r += 2) : this._motionData.segments[n].basePointIndex = s - 1, e.getMotionCurveSegment(t, r)) {
                            case O.CubismMotionSegmentType_Linear:
                                this._motionData.segments[n].segmentType = O.CubismMotionSegmentType_Linear, this._motionData.segments[n].evaluate = z, this._motionData.points[s] = new R(e.getMotionCurveSegment(t, r + 1), e.getMotionCurveSegment(t, r + 2)), s += 1, r += 3;
                                break;
                            ...
                            case O.CubismMotionSegmentType_InverseStepped:
                                this._motionData.segments[n].segmentType = O.CubismMotionSegmentType_InverseStepped, this._motionData.segments[n].evaluate = H, this._motionData.points[s] = new R(e.getMotionCurveSegment(t, r + 1), e.getMotionCurveSegment(t, r + 2)), s += 1, r += 3;
                                break;
                            default:
                                f(0)
                        }++i.segmentCount, ++n
            ...
            calcClippedDrawTotalBounds(t, e) {
                ...
                for (let a = 0; a < o; a++) {
                    ...
                    for (let t = p.vertexOffset; t < m; t += p.vertexStep) {
                        const e = u[t],
                            i = u[t + 1];
                        e < h && (h = e), e > c && (c = e), i < d && (d = i), i > g && (g = i)
                    }
                    if (h != Number.MAX_VALUE)
                        if (h < i && (i = h), d < r && (r = d), c > s && (s = c), g > n && (n = g), i == Number.MAX_VALUE) e._allClippedDrawRect.x = 0, e._allClippedDrawRect.y = 0, e._allClippedDrawRect.width = 0, e._allClippedDrawRect.height = 0, e._isUsing = !1;
                        else {
                            e._isUsing = !0;
                            const t = s - i,
                                o = n - r;
        ...
        class ht {
            ...
            setupShaderProgram(t, e, i, s, n, o, a, l, u, h, d, c, p) {
                ...
                if (null != v) {
                    ...
                    this.gl.uniform4f(t.uniformBaseColorLocation, 2 * n.x - 1, 2 * n.y - 1, 2 * n.getRight() - 1, 2 * n.getBottom() - 1), g = this.gl.ZERO, m = this.gl.ONE_MINUS_SRC_COLOR, f = this.gl.ZERO, _ = this.gl.ONE_MINUS_SRC_ALPHA
                } else {
                    ...
                    switch (u) {
                        ...
                        default:
                            l = this._shaderSets[dt.ShaderNames_NormalPremultipliedAlpha + n], g = this.gl.ONE, m = this.gl.ONE_MINUS_SRC_ALPHA, f = this.gl.ONE, _ = this.gl.ONE_MINUS_SRC_ALPHA;
                            break;
                        case r.CubismBlendMode_Additive:
                            l = this._shaderSets[dt.ShaderNames_AddPremultipliedAlpha + n], g = this.gl.ONE, m = this.gl.ONE, f = this.gl.ZERO, _ = this.gl.ONE;
                            break;
                        case r.CubismBlendMode_Multiplicative:
                            l = this._shaderSets[dt.ShaderNames_MultPremultipliedAlpha + n], g = this.gl.DST_COLOR, m = this.gl.ONE_MINUS_SRC_ALPHA, f = this.gl.ZERO, _ = this.gl.ONE
                    }
                ...
                null == a.index && (a.index = this.gl.createBuffer()), this.gl.bindBuffer(this.gl.ELEMENT_ARRAY_BUFFER, a.index), this.gl.bufferData(this.gl.ELEMENT_ARRAY_BUFFER, n, this.gl.DYNAMIC_DRAW), this.gl.blendFuncSeparate(g, m, f, _)
            }
        ...
        const ct = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;varying vec4       v_myPos;uniform mat4       u_clipMatrix;void main(){   gl_Position = u_clipMatrix * a_position;   v_myPos = u_clipMatrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}",
            pt = "precision mediump float;varying vec2       v_texCoord;varying vec4       v_myPos;uniform vec4       u_baseColor;uniform vec4       u_channelFlag;uniform sampler2D  s_texture0;void main(){   float isInside =        step(u_baseColor.x, v_myPos.x/v_myPos.w)       * step(u_baseColor.y, v_myPos.y/v_myPos.w)       * step(v_myPos.x/v_myPos.w, u_baseColor.z)       * step(v_myPos.y/v_myPos.w, u_baseColor.w);   gl_FragColor = u_channelFlag * texture2D(s_texture0, v_texCoord).a * isInside;}",
            gt = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;uniform mat4       u_matrix;void main(){   gl_Position = u_matrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}",
        ...
        class St extends J.a {
            ...
            getLayout() {
                return bt()(Object.assign({}, this.settings.layout), (t, e) => e.charAt(0).toLowerCase() + e.slice(1))
            }
            setupLayout() {
            ...
            draw(t) {
                const e = this.drawingMatrix,
                    i = Pt.getArray();
                i[0] = e.a, i[1] = e.b, i[4] = -e.c, i[5] = -e.d, i[12] = e.tx, i[13] = e.ty, this.renderer.setMvpMatrix(Pt), this.renderer.setRenderState(t.getParameter(t.FRAMEBUFFER_BINDING), this.viewport), this.renderer.drawModel()
            }
            destroy() {
        ...
        function Tt(t) {
            t = Object.assign({
                ...
                loggingLevel: g.LogLevel_Verbose
        ...
        class Gt {
            constructor() {
                this._options = new zt, this._options.gravity.y = -1, this._options.gravity.x = 0, this._options.wind.x = 0, this._options.wind.y = 0
            }
            static create(t) {
                const e = new Gt;
            ...
            evaluate(t, e) {
                ...
                const l = new n;
                let u, h, d, c, p, g, m, f;
                p = t.getModel().parameters.values, g = t.getModel().parameters.maximumValues, m = t.getModel().parameters.minimumValues, f = t.getModel().parameters.defaultValues;
                for (let _ = 0; _ < this._physicsRig.subRigCount; ++_) {
                    ...
                    for (let e = 0; e < u.inputCount; ++e) r = h[e].weight / 100, -1 == h[e].sourceParameterIndex && (h[e].sourceParameterIndex = t.getParameterIndex(h[e].source.id)), h[e].getNormalizedParameterValue(l, i, p[h[e].sourceParameterIndex], m[h[e].sourceParameterIndex], g[h[e].sourceParameterIndex], f[h[e].sourceParameterIndex], u.normalizationPosition, u.normalizationAngle, h[e].reflect, r);
                    ...
                    for (let e = 0; e < u.outputCount; ++e) {
                        ...
                        const s = d[e].destinationParameterIndex,
                            o = !Float32Array.prototype.slice && "subarray" in Float32Array.prototype ? JSON.parse(JSON.stringify(p.subarray(s))) : p.slice(s);
                        ee(o, m[s], g[s], a, d[e]);
                ...
                for (let t = 0; t < this._physicsRig.subRigCount; ++t) {
                    ...
                    for (let i = 0; i < n.inputCount; ++i) {
                        ...
                        switch (r.sourceParameterIndex = -1, r.weight = e.getInputWeight(t, i), r.reflect = e.getInputReflect(t, i), e.getInputType(t, i)) {
                            ...
                            case "Y":
                                ...
                                break;
                            case "Angle":
                                r.type = Bt.CubismPhysicsSource_Angle, r.getNormalizedParameterValue = Ht
                        }
                    ...
                    for (let i = 0; i < n.outputCount; ++i) {
                        ...
                        switch (r.destinationParameterIndex = -1, r.vertexIndex = e.getOutputVertexIndex(t, i), r.angleScale = e.getOutputAngleScale(t, i), r.weight = e.getOutputWeight(t, i), r.destination.targetType = Ot.CubismPhysicsTargetType_Parameter, r.destination.id = e.getOutputDestinationId(t, i), e.getOutputType(t, i)) {
                            case "X":
                                r.type = Bt.CubismPhysicsSource_X, r.getValue = Yt, r.getScale = Jt;
                                break;
                            case "Y":
                                r.type = Bt.CubismPhysicsSource_Y, r.getValue = qt, r.getScale = Qt;
                                break;
                            case "Angle":
        ...
        class n extends AMotion {
            constructor(t) {
                super(), this.params = [], this.setFadeIn(t.fade_in > 0 ? t.fade_in : s.b.expressionFadingDuration), this.setFadeOut(t.fade_out > 0 ? t.fade_out : s.b.expressionFadingDuration), Array.isArray(t.params) && t.params.forEach(t => {
                    const e = t.calc || "add";
                    if ("add" === e) {
                        const e = t.def || 0;
                        t.val -= e
        ...
        class o extends r.a {
            constructor(t, e) {
                var i;
                super(t, e), this.queueManager = new MotionQueueManager, this.definitions = null !== (i = this.settings.expressions) && void 0 !== i ? i : [], this.init()
            }
            isFinished() {
                return this.queueManager.isFinished()
            }
        ...
        class u extends l.a {
            ...
            init(t) {
                super.init(t), this.settings.expressions && (this.expressionManager = new o(this.settings, t))
            }
            isFinished() {
                return this.queueManager.isFinished()
            }
            createMotion(t, e, i) {
                const r = Live2DMotion.loadMotion(t),
                    n = e === this.groups.idle ? s.b.idleMotionFadingDuration : s.b.motionFadingDuration;
                return r.setFadeIn(i.fade_in > 0 ? i.fade_in : n), r.setFadeOut(i.fade_out > 0 ? i.fade_out : n), r
            }
            getMotionFile(t) {
                return t.file
            }
        ...
        var h, d = i(0);
        ! function (t) {
            t[t.Idle = 0] = "Idle", t[t.Closing = 1] = "Closing", t[t.Closed = 2] = "Closed", t[t.Opening = 3] = "Opening"
        }(h || (h = {}));
        class c {
            constructor(t) {
                this.coreModel = t, this.blinkInterval = 4e3, this.closingDuration = 100, this.closedDuration = 50, this.openingDuration = 150, this.eyeState = h.Idle, this.eyeParamValue = 1, this.closedTimer = 0, this.nextBlinkTimeLeft = this.blinkInterval, this.leftParam = t.getParamIndex("PARAM_EYE_L_OPEN"), this.rightParam = t.getParamIndex("PARAM_EYE_R_OPEN")
            }
            setEyeParams(t) {
                this.eyeParamValue = Object(d.b)(t, 0, 1), this.coreModel.setParamFloat(this.leftParam, this.eyeParamValue), this.coreModel.setParamFloat(this.rightParam, this.eyeParamValue)
            }
            update(t) {
                switch (this.eyeState) {
                    case h.Idle:
                        this.nextBlinkTimeLeft -= t, this.nextBlinkTimeLeft < 0 && (this.eyeState = h.Closing, this.nextBlinkTimeLeft = this.blinkInterval + this.closingDuration + this.closedDuration + this.openingDuration + Object(d.g)(0, 2e3));
                        break;
                    case h.Closing:
                        this.setEyeParams(this.eyeParamValue + t / this.closingDuration), this.eyeParamValue <= 0 && (this.eyeState = h.Closed, this.closedTimer = 0);
                        break;
                    case h.Closed:
                        this.closedTimer += t, this.closedTimer >= this.closedDuration && (this.eyeState = h.Opening);
                        break;
                    case h.Opening:
                        this.setEyeParams(this.eyeParamValue + t / this.openingDuration), this.eyeParamValue >= 1 && (this.eyeState = h.Idle)
                }
            }
        }
        ...
        class g extends a.a {
            ...
            updateWebGLContext(t, e) {
                ...
                for (const t in i) i.hasOwnProperty(t) && i[t] instanceof WebGLBuffer && (i[t] = null);
            ...
            getHitAreaDefs() {
                var t;
                return (null === (t = this.settings.hitAreas) || void 0 === t ? void 0 : t.map(t => ({
                    id: t.id,
                    name: t.name,
            ...
            update(t, e) {
                ...
                this.emit("beforeMotionUpdate");
                const o = this.motionManager.update(this.coreModel, e);
                this.emit("afterMotionUpdate"), n.saveParam(), o || null === (i = this.eyeBlink) || void 0 === i || i.update(t), this.updateFocus(), this.updateNaturalMovements(t, e), null === (r = this.physics) || void 0 === r || r.update(e), null === (s = this.pose) || void 0 === s || s.update(t), this.emit("beforeModelUpdate"), n.update(), n.loadParam()
            }
            updateFocus() {
            ...
            draw(t) {
                ...
                p[0] = i.a, p[1] = i.b, p[4] = i.c, p[5] = i.d, p[12] = i.tx, p[13] = i.ty, this.coreModel.setMatrix(p), this.coreModel.draw(), this.disableCulling = e
            }
            destroy() {
        ...
        class f extends m.a {
            constructor(t) {
                if (super(t), this.motions = {}, !f.isValidJSON(t)) throw new TypeError("Invalid JSON.");
                this.moc = t.model, Object(d.c)("string", t, this, "textures", "textures"), this.copy(t)
            }
            static isValidJSON(t) {
                var e;
                return !!t && "string" == typeof t.model && (null === (e = t.textures) || void 0 === e ? void 0 : e.length) > 0 && t.textures.every(t => "string" == typeof t)
            }
            copy(t) {
                Object(d.d)("string", t, this, "name", "name"), Object(d.d)("string", t, this, "pose", "pose"), Object(d.d)("string", t, this, "physics", "physics"), Object(d.d)("object", t, this, "layout", "layout"), Object(d.d)("object", t, this, "motions", "motions"), Object(d.c)("object", t, this, "hit_areas", "hitAreas"), Object(d.c)("object", t, this, "expressions", "expressions"), Object(d.c)("object", t, this, "init_params", "initParams"), Object(d.c)("object", t, this, "init_opacities", "initOpacities")
            }
            replaceFiles(t) {
                ...
                t.forEach(({
                    ...
                    if (t >= 0)
                        if (s == e) i.setPartsOpacity(t, r);
                            ...
                            let e, s = i.getPartsOpacity(t);
                            e = r < .5 ? -.5 * r / .5 + 1 : .5 * (1 - r) / .5, (1 - e) * (1 - r) > .15 && (e = 1 - .15 / (1 - r)), s > e && (s = e), i.setPartsOpacity(t, s)
                        }
                })
            }
            copyOpacity(t) {
        ...
        "use strict";
        if (!window.Live2D) throw new Error("Cannot find Cubism 2 runtime. Did you forget to include the live2d.min.js?")
    }, function (t, e, i) {
        "use strict";
        ...
        t.exports = function (t, e) {
            var i = n(t),
                ...
                m = g.length;
            for (var f in t) !e && !u.call(t, f) || p && ("length" == f || d && ("offset" == f || "parent" == f) || c && ("buffer" == f || "byteLength" == f || "byteOffset" == f) || a(f, m)) || g.push(f);
            return g
        }
    }, function (t, e) {
        t.exports = function (t, e) {
        ...
        t.exports = function (t, e, i, p, g, m) {
            ...
            if (b && !y) return m || (m = new r), f || h(t) ? s(t, e, i, p, g, m) : n(t, e, v, i, p, g, m);
            if (!(1 & i)) {
        ...
        t.exports = function (t, e, i, n, o, a) {
            ...
            if (m && !f) {
                var y = t.constructor,
                    M = e.constructor;
                y == M || !("constructor" in t) || !("constructor" in e) || "function" == typeof y && y instanceof y && "function" == typeof M && M instanceof M || (m = !1)
            }
